...
const Inicio = () => {
  return (
    <div className='home'>
      <h1>Soy <em>Bea</em>, <strong>desarrolladora web</strong> y <strong>diseñadora UX/UI</strong>.</h1>
      ...
      <h2> El curso pasado completé un bootcamp de desarrollo web y ahora he ampliando mis conocimientos en diseño UX/UI a través de otro.</h2>
